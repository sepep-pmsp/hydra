...
class CensoResource(ConfigurableResource):
    ...
    URL_CENSO_2022:str = 'https://ftp.ibge.gov.br/Censos/Censo_Demografico_2022/Agregados_por_Setores_Censitarios_preliminares/malha_com_atributos/setores/json/UF/SP/SP_Malha_Preliminar_2022.zip'
    ...
    def download_zipfile(self, censo_year:str = "2010") -> bytes:
        ...
        r = requests.get(self.URL_CENSO_2022)
        zip_content = r.content
        return zip_content
